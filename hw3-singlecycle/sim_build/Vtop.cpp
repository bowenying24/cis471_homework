...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__Processor__DOT__datapath__DOT__adder{vlSymsp->TOP.__PVT__Processor__DOT__datapath__DOT__adder}
    , __PVT__Processor__DOT__datapath__DOT__adder_reg{vlSymsp->TOP.__PVT__Processor__DOT__datapath__DOT__adder_reg}
    , __PVT__Processor__DOT__datapath__DOT__subber_reg{vlSymsp->TOP.__PVT__Processor__DOT__datapath__DOT__subber_reg}
    , rootp{&(vlSymsp->TOP)}
{
